...
;; Instead of default-mode being lisp, make it text.  Uncomment the other option
;; to force auto-fill for everything (sometimes not good when programming,
;; though -- depends on how you write codex).
...
;; Auto-reload buffers if they change out from underneath us (as long as we
;; haven't changed them in emacs), highlight searches as you type them, support
;; loading of compressed files directly, overwrite selections when typed.
...
;(iswitchb-mode           1) ;; obsoleted in emacs 24.smth
...
;; Special Display Buffers -- if enabled, whatever buffers match names in this
;; list are created as separate windows (frames), instead of splitting the
;; current buffer.
