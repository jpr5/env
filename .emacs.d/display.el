...
;; Tell Emacs to always syntax-hightlight everything to its fullest extent, and
;; don't wait to fontify (do it immediately).
;;
;; !!WARNING!!: might be responsible for inexplicable/inescapable hangs
(global-font-lock-mode t)
(setq font-lock-maximum-decoration t)
;(setq font-lock-maximum-size nil) ; obsolete since 24.1
;(setq font-lock-support-mode 'jit-lock-mode)
;(setq jit-lock-stealth-time 0) ; SUSPECT
